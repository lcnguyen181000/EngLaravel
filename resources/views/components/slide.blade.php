...
<div class="slider-area an-1 hm-1">
    ...
    <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides" style="height: 800px;overflow: hidden;">
            <img src="{{ asset('images/maxresdefault.jpg') }}" alt="" class="img img-resposive" title="#slider-direction-1" />
        </div>
        <!-- direction 1 -->
